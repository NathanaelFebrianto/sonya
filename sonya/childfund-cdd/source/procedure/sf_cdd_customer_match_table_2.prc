CREATE OR REPLACE PROCEDURE sf_cdd_customer_match_table_2
IS
/******************************************************************************
   NAME:       sf_cdd_customer_match_table_2 
   PURPOSE:    ACCOUNTM-> DW_CDD_CUSTOMER_MATCHING 테이블로 초기적재
...
END sf_cdd_customer_match_table_2;
