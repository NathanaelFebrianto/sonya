...
public class SpamLord {
	...
	/*
	 * You do not need to modify anything in the Contact class. This class
	 * encapsulates the basic information associated with an e-mail or phone
	 * number for this assignment. It has three data members: filename // the
	 * name of the file in which the contact item was found type // the type of
	 * contact information found: either "e" or "p" value // the actual string
	 * representatino of the e-mail or phone number // see assignment
	 * description for details you can ignore the other functions which are just
	 * necessary for correct behavior when used an element of a java.uitl.Set
	 */
	class Contact implements Comparable<Contact> {
		...
		public boolean equals(Object o) {
			Contact c = (Contact) o;
			return (fileName.equals(c.fileName) && type.equals(c.type) && value
					.equals(c.value));
		}

		@Override
		public int hashCode() {
			return 31 * fileName.hashCode() + 17 * type.hashCode()
					+ value.hashCode();
		}
	...
	/*
	 * TODO This should return a list of Contact objects found in the input. You
	 * can change anything internal to this function but make sure you leave the
	 * interface (arguments and return value) unchanged because it will be
	 * directly called by the submission script.
	 */
	...
	/*
	 * You should not need to edit this function It simply reads in a tsv gold
	 * file and returns a list of Contacts
	 */
	...
	/*
	 * You should not need to edit this. This is just a utility function which
	 * turns a Set into a sorted list for convenience when looking at the
	 * output.
	 */
	...
	/*
	 * You should not need to edit this. This takes in two Lists of Contacts and
	 * prints out the intersection and differences, which can be thought of as
	...
	private void score(List<Contact> guesses, List<Contact> gold) {
		...
		System.out.println("guess_set.size()=" + guess_set.size()
				+ "\tgold_set.size()=" + gold_set.size());
		...
		System.out.println("Summary: tp=" + tp.size() + "\tfp=" + fp.size()
				+ "\tfn=" + fn.size());
	}

	/*
	 * main takes a directory and a file with the Gold contacts. it processes
	 * each file in the directory, extracting any contacts and compares them to
	 * the contacts listed in the gold file
	 */
