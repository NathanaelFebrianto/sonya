 ...
 * All rights reserved.
 */
package org.firebird.collector.util;
...
/**
 * This class is a collector job logger.
 * 
 * @author Young-Gue Bae
 */
public class CollectJobLogger {
	 ...
	 */
	public CollectJobLogger(Class<?> name) {
		try {
	 ...
	 */
	public static CollectJobLogger getLogger(Class<?> name) {
		if (instance == null) {
			instance = new CollectJobLogger(name);
		}		
		return instance;
	}
