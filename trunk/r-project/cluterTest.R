...
# You may need to install all the packages for these labs to work correctly. 
...
#install.packages("NetData", repos = "http://cran.cnr.berkeley.edu/", dependencies = TRUE)install.packages("igraph", repos = "http://cran.cnr.berkeley.edu/", dependencies = TRUE)
#install.packages("sna", repos = "http://cran.cnr.berkeley.edu/", dependencies = TRUE)
#install.packages("animation", repos = "http://cran.cnr.berkeley.edu/", dependencies = TRU
#install.packages("NetCluster", repos = "http://cran.cnr.berkeley.edu/", dependencies = TRUEE)
#install.packages("MASS", repos = "http://cran.cnr.berkeley.edu/", dependencies = TRUE)
