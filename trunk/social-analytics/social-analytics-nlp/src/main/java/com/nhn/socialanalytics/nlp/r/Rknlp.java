package com.nhn.socialanalytics.nlp.r;
...
import com.nhn.socialanalytics.nlp.view.GraphModeller;
import com.nhn.socialanalytics.nlp.view.GraphTreeViewer;
...
public class Rknlp {
	...
	public String[] morphemeList(String text) {		
		...
		for (int i = 0; i < sentence.size(); i++) {
			Eojeol eojeol = (Eojeol) sentence.get(i);
	...
	public String[] parseTree(String text) {		
		...
		ParseTree tree = analyzer.analyze(text);
