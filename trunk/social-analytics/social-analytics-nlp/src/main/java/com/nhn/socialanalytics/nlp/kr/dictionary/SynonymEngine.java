package com.nhn.socialanalytics.nlp.kr.dictionary;
...
public class SynonymEngine {
	...
	private static final String SYNONYM_DICTIONARY = "com/nhn/socialanalytics/nlp/kr/dictionary/synonym.dic";
	private static RAMDirectory directory;
	private static IndexSearcher searcher;
	private static SynonymEngine instance;
	private List<String> synonyms = new ArrayList<String>();
	
	public static SynonymEngine getInstance() {
		if (instance == null) {
	...
	private void loadDictionary() {
		synonyms = DictionaryFactory.loadDictionary(SYNONYM_DICTIONARY);	
	}
	...
	public static void main(String[] args) {
		try {
			SynonymEngine synonymEngine = SynonymEngine.getInstance();
