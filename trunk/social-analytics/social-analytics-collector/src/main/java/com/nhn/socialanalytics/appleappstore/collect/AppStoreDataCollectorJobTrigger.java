...
public class AppStoreDataCollectorJobTrigger {
	// logger
	private static JobLogger logger = JobLogger.getLogger(AppStoreDataCollectorJobTrigger.class, "appstore-collect.log");
	...
	public static void main(String[] args) throws Exception {
		AppStoreDataCollectorJobTrigger trigger = new AppStoreDataCollectorJobTrigger();
		trigger.run();
	}	
}
