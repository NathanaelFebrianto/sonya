package org.sonya.webapp.listener;
...
import org.sonya.webapp.action.ApplicationResourcesInitializer;
...
public class StartupListener implements ServletContextListener {
    ...
    public static void setupContext(ServletContext context) {
    	...
    	ApplicationContext ctx = 
            WebApplicationContextUtils.getRequiredWebApplicationContext(context);
        try {
        	ApplicationResourcesInitializer ar = (ApplicationResourcesInitializer)ctx.getBean("applicationResourcesInitializer");
        	ar.initResources(context);
        } catch (Exception e) {
            log.error("Can't load application resources.", e);
        }

        if (log.isDebugEnabled()) {
            log.debug("Drop-down initialization completed.");
        }    
    }
