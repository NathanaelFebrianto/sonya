CREATE OR REPLACE PROCEDURE sf_cdd_customer_match_table_1
IS
/******************************************************************************
   NAME:       sf_cdd_customer_match_table_1 
   PURPOSE:    SUPERM -> DW_CDD_CUSTOMER_MATCHING 테이블로 초기적재
   ...
   Automatically available Auto Replace Keywords:
      Object Name:     sf_cdd_customer_match_table_1 
      Sysdate:         2008-09-09
...
END sf_cdd_customer_match_table_1;
