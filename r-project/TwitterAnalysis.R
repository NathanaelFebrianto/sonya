...
# Plot the sentiment time series of audience for the specified user
plotAudienceSentimentByTimeSeries <- function (user_name) {	
...
# Plot the sentiment time series of popular user for the specified user
plotPopularSentimentByTimeSeries <- function (user_name) {
	# Get subset of the user
	df_user = subset(df_all, 
			select = c("create_date", 
					"p.total_tweet_count",
...
plotAudienceSentimentByTimeSeries("BarackObama")
